...
-- CreateEnum
CREATE TYPE "EventCategory" AS ENUM ('SOCIAL', 'SPORTS', 'FOOD', 'MUSIC', 'OUTDOOR', 'OTHER');

-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('ACTIVE', 'CANCELLED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('EVENT_JOIN', 'EVENT_UPDATED', 'EVENT_CANCELLED');
...
CREATE TABLE "User" (
    ...
    "discoveryRadius" DOUBLE PRECISION NOT NULL DEFAULT 10,
